          ...
          <div className="absolute top-3 left-3 flex flex-col gap-1.5">
            {hasDiscount && (
              <motion.div
                ...
                className="flex items-center gap-1 bg-destructive text-destructive-foreground text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full shadow-md"
              >
